...
export const PARENT_TOUR = {
  banner: "미리보기 — 예시 가족의 화면이에요.", // 4정거장 상시 상단(정직 배너)
  exitCta: "이제 우리 아이 프로필을 만들어볼까요?", // 마지막 정거장 '다음' = 종료 CTA(자녀설정 이동)
  // 정거장 안내 4 (①편지 ②씨앗 ③책장 도장체험 ④자녀설정) — 순서 고정
  stations: [
    "키디가 아이와 나눈 한 주를 편지로 전해요. 무슨 감정을 지나왔는지 흐름으로 보여드려요.",
    "오늘 저녁, 이렇게 말 걸어보세요 — 키디가 아이 마음에 맞는 한마디를 골라드려요.",
    "아이가 간직한 그림일기예요. 도장을 찍어 마음을 돌려줄 수 있어요. 한번 찍어보세요!",
