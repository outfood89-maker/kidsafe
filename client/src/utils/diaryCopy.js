...
export const PARENT_TOUR = {
  ...
  // 정거장 안내 8 (①편지 ②씨앗 ③책장 도장체험 ④스케줄 ⑤안전알림 ⑥시청분석 ⑦시청기록 ⑧자녀설정) — 순서 고정, 자녀설정은 항상 마지막
  stations: [
    "키디가 아이와 나눈 한 주를 편지로 전해요. 무슨 감정을 지나왔는지 흐름으로 보여드려요.",
    "오늘 저녁, 이렇게 말 걸어보세요 — 키디가 아이 마음에 맞는 한마디를 골라드려요.",
    "아이가 간직한 그림일기예요. 부모는 이렇게 도장과 짧은 편지로 아이 마음에 답해줄 수 있어요.",
    "아이 일정을 달력에 기록해요. \"13일 태권도 넣어줘\"처럼 키디에게 말로 부탁하면 대신 적어드려요.",
    // ⑤ 안전 알림 — 팀장 §7 스탬프 verbatim 확정(컨트롤타워)
    "아이가 기준보다 위험한 영상을 보면 여기 남겨드려요. 마음이 힘들어 보이는 날도, 무슨 일인지 캐묻지 않고 살며시 알려드려요.",
    // ⑥ 시청 분석 — 팀장 §4 스탬프 verbatim 확정(컨트롤타워)
    "아이가 본 영상을 항목별로 꼼꼼히 살펴본 결과예요. 키디가 숫자 대신, 오늘 무엇을 하면 좋을지로 풀어드려요.",
    // ⑦ 시청 기록 — 팀장 §4 스탬프 verbatim 확정(컨트롤타워)
    "아이가 본 영상이 안전도 점수와 함께 차곡차곡 남아요. 언제든 무엇을 봤는지 돌아볼 수 있어요.",
    "안전 기준·시청 시간처럼, 우리 아이에게 맞는 설정을 여기서 정해요.", // ⑧ 자녀설정 — 항상 마지막
  ],
