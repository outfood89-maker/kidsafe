          ...
          <div className="flex flex-wrap justify-center gap-10">
            ...
            {profiles.map((profile) => (
              <button
                ...
                className="group flex flex-col items-center gap-4 transition duration-300 hover:-translate-y-3"
              >
                {/* 아바타 — 성별 반영 + 크게 표시 */}
                <div className="h-48 w-48 overflow-hidden rounded-3xl bg-white shadow-xl transition duration-300 group-hover:shadow-2xl group-hover:ring-4 group-hover:ring-pink-400">
                  <img
                ...
                <p className="text-2xl font-extrabold text-gray-700 group-hover:text-pink-500">
                  {profile.name}
                </p>
                <p className="text-sm text-gray-400">{profile.age}세</p>
              </button>
            ))}
            ...
            {profiles.length < 4 && (
              <button
                ...
                className="group flex flex-col items-center gap-4 transition duration-300 hover:-translate-y-3"
              >
                <div className="flex h-48 w-48 items-center justify-center rounded-3xl border-4 border-dashed border-gray-300 bg-white shadow-xl transition duration-300 group-hover:border-pink-400 group-hover:shadow-2xl">
                  <FaPlus className="text-5xl text-gray-300 group-hover:text-pink-400" />
                </div>
                <p className="text-2xl font-extrabold text-gray-400 group-hover:text-pink-500">
                  프로필 추가
                </p>
                <p className="text-sm text-gray-300">부모모드에서 추가</p>
              </button>
            )}
