...
import { TOUR_SEED, TOUR_SCHEDULES, TOUR_GREETING } from "../utils/tourSeed"; // AD-7: 하드코딩 예시 시드(폴백·메모리 전용·서버/저장 0) + 탭 데모(스케줄)
...
const TOUR_STATIONS = [
  ...
  { tab: "schedule", targetId: "tour-schedule", interactive: false }, // ④ 신규 — 스케줄러(시드 주입·읽기전용)
