...
import { TOUR_SEED, TOUR_SCHEDULES, TOUR_GREETING, TOUR_ALERTS, TOUR_CARE_SIGNALS, TOUR_ALERT_SETTINGS, TOUR_BLOCKED_KEYWORDS } from "../utils/tourSeed"; // AD-7: 하드코딩 예시 시드(폴백·메모리 전용·서버/저장 0) + 탭 데모(스케줄·안전)
...
const TOUR_STATIONS = [
  ...
  { tab: "safety",   targetId: "tour-safety",   interactive: false }, // ⑤ 신규 — 안전 알림(state 직접 주입·스코프우회·읽기전용)
  { tab: "children", targetId: "tour-settings", interactive: false }, // ⑥ (종료 CTA)
];
...
export default function ParentDashboard() {
  ...
  const startTour = () => {
    ...
    setHistory([]); setAlerts(TOUR_ALERTS); setCareSignals(TOUR_CARE_SIGNALS); setProfileBadges({});
