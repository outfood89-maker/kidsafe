...
const OX_QUESTIONS = [
  ...
  { q: "돌멩이도 오랜 시간이 지나면 흙이 돼요", answer: true },
  { q: "봄, 여름, 가을, 겨울은 4계절이에요", answer: true },
  { q: "눈(雪)은 구름에서 만들어져요", answer: true },
  { q: "지구에는 산, 바다, 사막 등 다양한 지형이 있어요", answer: true },
  ...
  { q: "개미집 안에는 여왕개미, 일개미, 수개미가 있어요", answer: true },
  ...
  { q: "두유와 우유는 칼슘이 풍부해요", answer: true },
  ...
  { q: "봄, 여름, 가을, 겨울 중 가장 더운 계절은 여름이에요", answer: true },
  ...
  { q: "지구는 태양계에서 유일하게 생명체가 사는 행성이에요", answer: true },
    ...
    >
          ...
          {Array.from({ length: TOTAL }).map((_, i) => (
            <div
              ...
              style={{
                ...
                backgroundColor: i < current ? "#6DAB60" : i === current ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.15)",
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 py-4">
        ...
        >
          ...
          {selected !== null && (
            <p className="mt-4 text-base font-bold" style={{ color: isCorrect ? "#A8E09A" : "#FF9090" }}>
