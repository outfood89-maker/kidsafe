...
- ⚠️ **CLAUDE.md 사본 2개 불일치**: `~/Downloads/Kiddy_source_2026-07-12 (1)/CLAUDE.md`(139줄·7/12 구버전) vs `~/Desktop/kidsafe/CLAUDE.md`(최신). **최신은 작업 폴더 쪽.** 세션이 구버전을 읽으면 커밋 게이트·검증 축 규칙이 누락된다.
