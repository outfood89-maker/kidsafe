...
# 질문 유형별 '시제/틀' 명시 — LLM이 '보고 싶은 것(미래)'을 '봤다(과거)'로 뒤집는 사고 방지.
# (예: watch_genre '동화' → "동화 봤구나" ❌ / "동화 보고 싶구나" ⭕)
FRAME_HINT = {
    "mood_today": "이건 아이의 '지금 기분'이야. 적힌 그대로만 받아.",
    "what_did_today": "이건 아이가 '오늘 이미 한 일'이야(과거). '~했구나'처럼 지난 일로 받아.",
    "watch_genre": (
        "이건 아이가 '이제부터 보고 싶은 것'이야(아직 안 봤어, 미래). "
...
def _react_system(name: str, tone: str = "bright") -> str:
    ...
    if tone == "calm":
        tone_block = (
            ...
            "- 활동 사실에 따뜻하고 잔잔하게만 반응하고 다음으로 넘겨. "
            "(한 일은 과거로: \"바깥에서 놀았구나. 키디가 좋은 거 골라줄게 🎬\" / "
            "보고 싶은 것은 앞일로: \"동화 보고 싶구나. 키디가 좋은 거 골라줄게 🎬\")"
        )
    else:
        tone_block = (
            "[지금은 '밝음(bright)' 톤]\n"
